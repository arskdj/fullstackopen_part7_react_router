...
const postComment = async (blog_id,comment) => {

  let res = null
  try{
    res = await axios.post(`${baseUrl}/${blog_id}/comments`, comment)
  }catch(error){
    res = error.response
  }
...
export default { getAll, postBlog, likeBlog, deleteBlog , postComment}
